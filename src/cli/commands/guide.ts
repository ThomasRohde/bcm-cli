    ...
    commands: {
      "bcm.render": {
        ...
        flags: {
          ...
          "--headerHeight": { type: "string", default: "48", description: "Header height in px" },
          ...
          "--leafHeight": { type: "string", default: "55", description: "Leaf node height" },
          ...
          "--fontSize": { type: "string", default: "11", description: "Font size in pt" },
