import type { LayoutNode, LayoutOptions } from "../core/types.js";
...
export function calculateSize(
  ...
  const isEffectiveLeaf = node.children.length === 0 ||
  ...
  // Compute child sizes first (recurse)
