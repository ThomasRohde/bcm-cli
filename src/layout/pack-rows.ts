import type { LayoutNode, LayoutOptions, PackResult, RowMeta } from "../core/types.js";

export function packRows(children: LayoutNode[], targetWidth: number, options: LayoutOptions): PackResult {
